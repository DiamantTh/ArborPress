...
- After unlocking, all old credentials remain in the DB but are
  cryptographically dead and should be removed manually; users
  re-enroll their passkeys against the new `rp.id`.
